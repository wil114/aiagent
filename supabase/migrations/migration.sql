...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:z+J/PTTOuS8hYFqSOlrHyQ==$FpV7xMOQOrioITKRSj4F4EIMEDn1TzO6AAlaC3QcRng=:XCp/kdmmIn9iXu2amLYq4mJThiiMgMS97Sn4soKtDgU=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Btoid/eEFRwbXae+VKObMQ==$1P9stz8WRJfW0UiboTijEps9Ul+UlcM23LoMoyRTKJs=:h8dRUbjLuHIjWWxdaU8l0sD6GOHazEn5/VaNg0Cwed0=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:aw0hO7m4/CqgDlgeLkIQPw==$c//wIqzTcxzIkOFK4j+TFKnfav9XRVRR90+cm7jLI4g=:T4XD6FyLUCmg8QQRxGxaMmUDkoUetxGoxxK577N2qHQ=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ZoZoL+UaApVSC4QvG6A0Dg==$v0wruWLz0h2qWbTsNqMShYCB+fNQdMCrXaqGk5pR/8w=:dyS35Aa0UcC+KlxBq8HeFjvHJP1wQ/qoKc3PNl5+oTU=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:fSKTHaaEAEjlnGM1pJRHKQ==$lL6lJpPD4E2Btxbln0mM5kQDS/oDduPanLE/Ovcj7hc=:kRzCN0/veZhG3EcxlSfTEDDSdj/BiDfIte/fp2cWCgE=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:KlCx1bU+evuNJU4jSOG20A==$DGp6eeR/HG/gTHPQHd6lcFQ1g2TKPzWvkwg1ie7+HKs=:Le7AeZyd3nAmh+pc5FoeXl0ImC9prj+7TvNVziH47xQ=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:tzjVH3BxIuhfDQy6/UbRYg==$9muY0/6NbTTF5vSNzzHh3YkdtkM76byEtOaMC5rUtEM=:gj1kXPoQY0RSh4T0o6yYeh3xs5UCXKqD0n7v0gA3UVI=';
...
CREATE TABLE "public"."ai_analyses" (
    ...
    CONSTRAINT "ai_analyses_status_check" CHECK (("status" = ANY (ARRAY['completed'::"text", 'partial'::"text", 'failed'::"text"])))
);
...
CREATE TABLE "public"."push_logs" (
    ...
    "error_msg" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "push_logs_platform_check" CHECK (("platform" = ANY (ARRAY['feishu'::"text", 'dingtalk'::"text"]))),
    CONSTRAINT "push_logs_status_check" CHECK (("status" = ANY (ARRAY['success'::"text", 'failed'::"text"])))
);
...
CREATE TABLE "public"."risk_logs" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "risk_logs_check_result_check" CHECK (("check_result" = ANY (ARRAY['passed'::"text", 'blocked'::"text", 'warning'::"text"])))
);
...
--
-- Name: supabase_realtime ai_analyses; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."ai_analyses";


--
-- Name: supabase_realtime push_logs; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."push_logs";
